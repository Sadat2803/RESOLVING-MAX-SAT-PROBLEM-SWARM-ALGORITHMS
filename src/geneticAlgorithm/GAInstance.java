...
public class GAInstance 
{
    ...
    public ArrayList<Individual> getNewParents()
    {
        ...
        /*for(int i=0;i<this.individualsList.size();i++)
        {
          if(this.individualsList.get(i).getEvaluationResult()>=maxResult)
          {
              parent1 = this.individualsList.get(i);
              maxResult = this.individualsList.get(i).getEvaluationResult();
          }
        }*/
        parent1=this.individualsList.get(ThreadLocalRandom.current().nextInt(this.individualsList.size()));
        maxResult = 0;
        /*for(int i=0;i<this.individualsList.size();i++)
        {  System.out.print(this.individualsList.get(i).getEvaluationResult()+" ,");
          if(this.individualsList.get(i).getEvaluationResult()>=maxResult && !this.individualsList.get(i).equals(parent1))
          {
              parent2 = this.individualsList.get(i);
              maxResult = this.individualsList.get(i).getEvaluationResult();
          }
        }*/
        parent2=this.individualsList.get(ThreadLocalRandom.current().nextInt(this.individualsList.size()));
        //ystem.err.println("Parent 2 est choisis : "+parent2.getGeneticData());
    ...
    {        
        ...
        for(int var=0; var<((RC*nbIndividuals)/100); var++)
        {
            ...
            //System.out.println("Parent1 :"+parent1.getGeneticData());
            //System.out.println("Parent2 :"+parent2.getGeneticData() +"\n");
