...
public class GA_GUIController implements Initializable,ExecutionController {
    ...
    public void launch() {
        ...
        try {
             ...
             */
            PrintWriter writer=new PrintWriter(new File("GAresults.csv"));
            ...
            HashMap<Integer,Double> resultsMap=new HashMap<>();
                ...
                //AFFICHAGE DES PARAMAETRES CHOISIS PAR L'UTILISATEUR
                 /*this.crossover_rate.setText(CR+"");
                 this.maximum_iterations.setText(maxit+"");
                 this.mutation_rate.setText(MR+"");
                 this.population_size.setText(popsize+"");*/
                 
                 
                 
            //for(int popsize=50;popsize<1000;popsize+=50){  // Massive Combination Execution
              //  for(int maxit=500;maxit<5000;maxit+=500){  //Massive Combination Execution
                ...
                //}
                 ...
                 //ACTIVATE THE GRAPH DISPLAY BUTTON
    ...
    private void initDefaultParams() {
        ...
        GA_GUIController.PARAMS.put("MaxIteration", 100);
